...
final class RectorConfig extends ContainerConfigurator
{
    ...
    public function importNames(bool $disableImportDocBlockNames = false): void
    {
        $parameters = $this->parameters();
        $parameters->set(Option::AUTO_IMPORT_NAMES, true);

        $parameters->set(Option::DISABLE_AUTO_IMPORT_DOC_BLOCK_NAMES, $disableImportDocBlockNames);
    }
