...
final class MissingInSetCommand extends Command
{
    ...
    private const RULES_DIRECTORY_TO_SET_CONFIG = [
        ...
        [__DIR__ . '/../../rules/TypeDeclaration/Rector' => __DIR__ . '/../../config/set/return-type-declaration.php'],
        [__DIR__ . '/../../rules/TypeDeclaration/Rector' => __DIR__ . '/../../config/set/parameter-type-declaration.php'],
        [__DIR__ . '/../../rules/TypeDeclaration/Rector' => __DIR__ . '/../../config/set/property-type-declaration.php'],
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach (self::RULES_DIRECTORY_TO_SET_CONFIG as [$rulesDirectory, $setFile]) {
            ...
            $hasError = true;
            $this->symfonyStyle->title('We could not find these rules in configs');
