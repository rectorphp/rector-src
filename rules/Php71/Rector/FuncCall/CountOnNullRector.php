...
CODE_SAMPLE
    ...
    public function refactorWithScope(Node $node, Scope $scope): int|Ternary|null|FuncCall
    {
        trigger_error(sprintf(
            'The "%s" rule is now deprecated as often reports false positives and requires custom refactoring of previous code. Use PHPStan to spot nullable arguments and refactor code to fit your use case.',
            self::class
        ), E_USER_ERROR);
    }
}
