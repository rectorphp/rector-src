...
namespace Rector\TypeDeclaration\Rector;
...
abstract class AbstractInlineVarDocToTypedPropertyRector extends AbstractRector implements MinPhpVersionInterface
{
    ...
    public function getRuleDefinition(): RuleDefinition
    {
        return new RuleDefinition(
            'Changes property `@var` annotations from annotation to type for private modifier or protected in final class without extends.',
            [
                new CodeSample(
                    <<<'CODE_SAMPLE'
