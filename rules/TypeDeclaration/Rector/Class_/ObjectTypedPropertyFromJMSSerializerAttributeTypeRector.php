...
final class ObjectTypedPropertyFromJMSSerializerAttributeTypeRector extends AbstractRector implements MinPhpVersionInterface
{
    public function __construct(
        ...
        private readonly JMSTypeAnalyzer $jmsTypeAnalyzer,
        private readonly JMSTypePropertyTypeFactory $jmsTypePropertyTypeFactory,
    ) {
    }

    public function getRuleDefinition(): RuleDefinition
    {
        return new RuleDefinition('Add object typed property from JMS Serializer Type attribute', [
            new CodeSample(
                <<<'CODE_SAMPLE'
