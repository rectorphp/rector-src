...
final class FalseReturnClassMethodToNullableRector extends AbstractRector
{
    public function __construct(
        ...
        private readonly ReturnFalseAndReturnOtherMatcher $returnFalseAndReturnOtherMatcher,
    ) {
    }

    public function getRuleDefinition(): RuleDefinition
    {
        return new RuleDefinition('Change class method that returns false as invalid state, to nullable', [
            new CodeSample(
                <<<'CODE_SAMPLE'
class SomeClass
{
