 ...
 */
final class ArrayParamTypeByMethodCallTypeRector extends AbstractParamTypeByMethodCallTypeRector
{
    public function getRuleDefinition(): RuleDefinition
    {
        return new RuleDefinition('Change array param type based on passed method call type', [
            new CodeSample(
                <<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    {
        return TypeCombinator::removeNull($type)->isArray()
            ->yes();
    }
}
