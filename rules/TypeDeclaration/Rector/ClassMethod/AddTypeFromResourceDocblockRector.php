...
final class AddTypeFromResourceDocblockRector extends AbstractRector implements MinPhpVersionInterface, ConfigurableRectorInterface, DeprecatedInterface
{
    ...
    {
        return new RuleDefinition('Add param and return types on resource docblock', [
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        throw new ShouldNotHappenException(sprintf(
            '"%s" rule is deprecated as it does not solve any real problem and breaks code. The manual work is still needed',
            self::class
        ));
    }
