...
/**
 * @see \Rector\Tests\CodeQuality\Rector\CallLike\NameBooleanOrNullArgumentRector\NameBooleanOrNullArgumentRectorTest
 */
final class NameBooleanOrNullArgumentRector extends AbstractRector
{
    ...
    public function getRuleDefinition(): RuleDefinition
    {
        return new RuleDefinition(
            'Add parameter names to boolean and null arguments to make call sites clearer.',
            [
                new CodeSample(
                    <<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    private function resolveFirstPositionToName(array $args, array $parameters): ?int
    {
        foreach ($args as $position => $arg) {
            ...
            if (! $this->isBooleanOrNull($arg->value)) {
                continue;
            }
    ...
    private function isBooleanOrNull(Expr $expr): bool
    {
        return $this->valueResolver->isTrueOrFalse($expr) || $this->valueResolver->isNull($expr);
    }
}
