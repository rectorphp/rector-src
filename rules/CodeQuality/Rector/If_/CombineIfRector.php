...
final class CombineIfRector extends AbstractRector implements DeprecatedInterface
{
    ...
    {
        return new RuleDefinition('Merge nested if statements', [
            new CodeSample(
                <<<'CODE_SAMPLE'
class SomeClass
{
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        throw new ShouldNotHappenException(sprintf(
            '"%s" rule is deprecated, as merging nested ifs can create much less readable code and depends on context',
            self::class
        ));
    }
}
