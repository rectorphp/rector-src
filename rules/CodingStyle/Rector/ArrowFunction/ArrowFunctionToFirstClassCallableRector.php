...
/**
 * @see \Rector\Tests\CodingStyle\Rector\ArrowFunction\ArrowFunctionToFirstClassCallableRector\ArrowFunctionToFirstClassCallableRectorTest
 */
final class ArrowFunctionToFirstClassCallableRector extends AbstractRector implements MinPhpVersionInterface
{
    public function __construct(
        private readonly ArrowFunctionAndClosureFirstClassCallableGuard $arrowFunctionAndCLosureFirstClassCallableGuard
    ) {
    }
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): null|CallLike
    {
        ...
        if ($this->arrowFunctionAndCLosureFirstClassCallableGuard->shouldSkip(
            $node,
            $callLike,
