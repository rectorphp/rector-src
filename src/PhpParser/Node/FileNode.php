...
class FileNode extends Stmt
{
    ...
    public function addImports(
        ...
        $namespaceName = $namespace instanceof Namespace_ && $namespace->name instanceof Name
     ...
     * @param FullyQualifiedObjectType[] $constantUseImportTypes
     */
    private function appendUsedImports(
        array $useImportTypes,
        array $functionUseImportTypes,
        array $constantUseImportTypes
    ): void {
        $this->usedImports = new UsedImports(
            array_merge($this->usedImports->getUseImports(), $useImportTypes),
            array_merge($this->usedImports->getFunctionImports(), $functionUseImportTypes),
            array_merge($this->usedImports->getConstantImports(), $constantUseImportTypes),
        );
    }
     ...
     * @return Nop[]
     */
    private function resolveInsertNop(self|Namespace_ $node): array
    {
