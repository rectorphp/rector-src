 ...
 */
final readonly class UseNodesToAddCollector
{
    public function __construct(
    ...
    public function isShortImported(File $file, FullyQualifiedObjectType $fullyQualifiedObjectType): bool
    {
        ...
        return $fileNode->getPendingImports()
            ->isShortImported($fullyQualifiedObjectType);
    }
    ...
    {
        $this->warn(
            'getConstantImportsByFilePath()',
            '$file->getFileNode()->getPendingImports()->getConstantImports()'
        );
    ...
    {
        $this->warn(
            'getFunctionImportsByFilePath()',
            '$file->getFileNode()->getPendingImports()->getFunctionImports()'
        );
