...
final class Option
{
    ...
    /**
     * @deprecated Use @see \Rector\Config\RectorConfig::disableImportDocBlockNames() instead
     * @var string
     */
    public const DISABLE_AUTO_IMPORT_DOC_BLOCK_NAMES = 'disable_auto_import_doc_block_names';
