...
final class RectorConfigBuilder
{
    ...
    public function withAttributesSets(
        ...
        bool $behat = false,
        bool $all = false,
        bool $symfonyRoute = false,
        bool $symfonyValidator = false
    ): self {
    ...
    public function withPreparedSets(
        ...
        $setMap = [
            ...
            PHPUnitSetList::PHPUNIT_NARROW_ASSERTS => $phpunitNarrowAsserts,
            PHPUnitSetList::PHPUNIT_MOCK_TO_STUB => $phpunitMockToStub,
