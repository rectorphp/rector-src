...
final class FileHashComputerTest extends AbstractLazyTestCase
{
    ...
    {
        $this->bootFromConfigFiles([__DIR__ . '/FixtureRectorPhpNotChanged/rector.php']);

        $hashedFile = $this->fileHashComputer->compute(__DIR__ . '/FixtureRectorPhpNotChanged/rector.php');

        copy(__DIR__ . '/FixtureRectorPhpNotChanged/rector.php', __DIR__ . '/FixtureRectorPhpNotChanged/rector_temp_equal.php');
        copy(__DIR__ . '/FixtureRectorPhpNotChanged/rector_rule_equals.php', __DIR__ . '/FixtureRectorPhpNotChanged/rector.php');

        SimpleParameterProvider::setParameter(Option::REGISTERED_RECTOR_RULES, null);

        $this->bootFromConfigFiles([__DIR__ . '/FixtureRectorPhpNotChanged/rector.php']);

        $newHashedFile = $this->fileHashComputer->compute(__DIR__ . '/FixtureRectorPhpNotChanged/rector.php');
        rename(__DIR__ . '/FixtureRectorPhpNotChanged/rector_temp_equal.php', __DIR__ . '/FixtureRectorPhpNotChanged/rector.php');
